...
Revision ID: b1b827b242f6
Revises: 7e3143dcedc8
Create Date: 2025-11-11 10:48:39.674991
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Boolean(),
            nullable=False,
            comment="Auxílio Alimentação",
        ),
        sa.Column(
            "housing_allowance", sa.Boolean(), nullable=False, comment="Auxílio Moradia"
        ),
        sa.Column(
            "daycare_allowance", sa.Boolean(), nullable=False, comment="Auxílio Creche"
        ),
        sa.Column(
            "graduation_scholarship",
            sa.Boolean(),
            nullable=False,
            comment="Bolsa Pró-Graduando",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "user_type",
            sa.Enum("NTI", "STUDENT", "COORDINATOR", "SOCIAL_WORKER", name="usertype"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("REVIEW", "REGISTRATION", name="formsketchtype"),
            nullable=False,
        ),
        sa.Column(
            "content",
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Chave do arquivo no S3",
        ),
        sa.Column(
            "file_type",
            sa.String(length=50),
    ...
    op.create_index(
        op.f("ix_student_registrations_id"),
        "student_registrations",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "ivs",
            sa.Numeric(precision=200, scale=0),
            nullable=True,
    ...
    op.create_index(
        op.f("ix_review_registrations_id"), "review_registrations", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_review_registrations_social_worker_id"),
        "review_registrations",
        ["social_worker_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "ocr_status",
            sa.Enum("PENDING", "PROCESSING", "SUCCESS", "FAILED", name="ocrstatus"),
    ...
    op.create_index(
        op.f("ix_student_documents_ocr_status"),
        "student_documents",
        ["ocr_status"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["review_registration_id"],
            ["review_registrations.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_appeals_id"), "appeals", ["id"], unique=False)
    op.create_index(
        op.f("ix_appeals_review_registration_id"),
        "appeals",
        ["review_registration_id"],
        unique=False,
    )
